...
@Component({
  selector: 'app-carpetas2019',
  templateUrl: './carpetas2019.component.html',
  styleUrls: ['./carpetas2019.component.css']
})
export class Carpetas2019Component implements OnInit {
  ...
  ngOnInit(): void {
    this.getCarpetas2019();
  }

  /* Creamos la funcion para hacer el llamado del universo de carpetas getCarpetas2019 */
  getCarpetas2019() {
    this.loading = true;
    this.carpetaInvestigacionService.getCarpetas2019().then(carpetas => {
